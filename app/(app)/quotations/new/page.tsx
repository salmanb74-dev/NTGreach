...
export default async function NewQuotationPage({
  ...
  if (searchParams.lead) {
    const { data } = await supabase
      .from('leads')
      .select('id, contact_name, company_name, email, address, quoted_setup_fee, quoted_mrr, payment_frequency, deal_currency, discount, tax_rate, payment_start_date, quoted_subscription')
